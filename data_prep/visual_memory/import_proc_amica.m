...
ica_root = [data_root 'amica/visual_memory'];
output_iclabel_root = [data_root 'amica_iclabel_ready/visual_memory'];
output_mara_root = [data_root 'amica_mara_ready/visual_memory'];
amica_out_root = [data_root 'amica_out/visual_memory'];
