...
ica_root = [data_root 'runica/bcic42a'];
output_iclabel_root = [data_root 'runica_iclabel_ready/bcic42a'];
output_mara_root = [data_root 'runica_mara_ready/bcic42a'];
amica_out_root = [data_root 'runica_out/bcic42a'];
